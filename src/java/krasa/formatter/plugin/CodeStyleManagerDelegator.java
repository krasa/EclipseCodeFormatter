...
public class CodeStyleManagerDelegator implements MethodInterceptor, Callback {
	...
	@Override
	public Object intercept(Object obj, Method invokedMethod, Object[] rawArguments, MethodProxy proxy)
			throws Throwable {
		try {
			...
			return PLEASE_REPORT_BUGS_TO_JETBRAINS_IF_IT_FAILS_HERE____ORIGINAL_INTELLIJ_FORMATTER_WAS_USED(
					invokedMethod, rawArguments);
